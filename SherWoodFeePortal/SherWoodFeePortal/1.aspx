<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1.aspx.cs" Inherits="SherWoodFeePortal._1" %>
   ...
   <input type="hidden" runat="server" id="key" name="key" />
      ...
      <table>
        ...
        <tr>
          <td>Success URI: </td>
          <td colspan="3">
          <asp:TextBox ID="surl" runat="server" Text="http://localhost:49306/FrmResponseHandler.aspx" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3">
          <asp:TextBox ID="furl" runat="server" Text="http://localhost:49306/FrmResponseHandler.aspx" /></td>
        </tr>
        <tr>
